...
const BannerOne = ({}) => {
  return (
    <div className="relative flex justify-center items-center h-[60vh] sm:h-[70vh] md:h-[80vh] overflow-hidden">
      ...
      <div className="__float-box-container_one absolute -inset-y-0 flex justify-center md:justify-end w-[100%] md:w-[90%]">
...
const BannerTwo = ({}) => {
  return (
    <div className="relative flex justify-center items-center h-[50vh] md:h-[80vh] overflow-hidden">
      ...
      <div className="__float-box-container_two absolute -inset-y-0 flex justify-center md:justify-start w-[100%] md:w-[90%]">
        <div className="__float-box_two bg-[url('https://themes.getmotopress.com/luviana/wp-content/uploads/sites/27/2019/07/image_testimonials.png')] bg-[#3f9cc1] bg-no-repeat bg-contain bg-left-top flex justify-center items-center h-full w-[90%] md:w-[50%] px-4 pt-10 pb-14 md:px-16 lg:px-20 md:py-20">
