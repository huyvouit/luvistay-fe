        ...
        <div className="posts">
            <div className="posts-container">
                ...
                <div className="posts-container-report">
                    ...
                    <div className="posts-container-report-box">
                        <h3 className="posts-container-report-box-btn" onClick={() => checkComment(!comment)}>Bình luận</h3>
                        <p className="posts-container-report-box-number">7</p>
                    </div>
                </div>

                <div className={ comment ? "posts-container-cmt" : "posts-container-cmt-hide"} >
                    <div className="posts-container-cmt-container">
                        <img className="posts-container-cmt-container-img" src={imgs[1]}/>
                        <input className="posts-container-cmt-container-input" placeholder="Viết bình luận..." />
                    ...
                    <div className="posts-container-cmt-container">
                        ...
                        <div className="posts-container-cmt-container-box">
                            ...
                            <h4 className="posts-container-cmt-container-box-information-name">Huy</h4>
                            <p className="posts-container-cmt-container-box-information-time">7 phút trước</p>
                            </div>
                            <p className="posts-container-cmt-container-box-description">Như vầy được chưa</p>
                        </div>
                    </div>
