...
const SignInPage = () => {
  ...
  <section className='login-page-container'>
      ...
      <form className='login-page-container-colum-two'>
          ...
          <h1 className='login-page-container-colum-two-title'>Chào mừng bạn đến với LuviStay</h1>
          <p className='login-page-container-colum-two-description'>Nơi cung cấp một dịch vụ đặt phòng rẻ và dễ dàng nhất.</p>
          ...
          <p className='to-sign-up'>Nếu bạn không có một tài khoản? <span className='span-two'>Đăng ký tại đây</span></p>
          </Link>
      </form>
  </section>
</div>
